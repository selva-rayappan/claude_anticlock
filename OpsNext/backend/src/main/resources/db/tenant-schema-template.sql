...
-- Executed once per tenant during provisioning.
-- search_path is SET to the target schema before execution.
-- NOTE: updated_at is managed explicitly in Java UPDATE statements.
